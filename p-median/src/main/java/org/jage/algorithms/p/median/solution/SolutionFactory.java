...
package org.jage.algorithms.p.median.solution;

import it.unimi.dsi.fastutil.ints.IntArrayList;
import org.jage.algorithms.p.median.input.InputData;
import org.jage.algorithms.p.median.input.InputDataHolder;
...
public class SolutionFactory extends ClassPropertyContainer implements
    ...
    public SolutionFactory() throws IOException {
    ...
    public IVectorSolution<Integer> createInitializedSolution() {
        ...
        for (int i = 0; i < problem.getDimension(); i++) {
            if (i < inputData.getFacilitiesNumber()) {
                representation[i] = 1;
            } else {
                representation[i] = 0;
            }
