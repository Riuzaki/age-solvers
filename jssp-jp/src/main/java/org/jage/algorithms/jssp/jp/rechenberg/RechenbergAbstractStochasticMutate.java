...
package org.jage.algorithms.jssp.jp.rechenberg;
...
/**
 * Abstract implementation of {@link org.jage.variation.mutation.IMutateSolution}. Features are not mutated independently. Instead, a random subset
 ...
 * @author AGH AgE Team
 */
public abstract class RechenbergAbstractStochasticMutate<R> extends AbstractStrategy implements
    ...
    protected RechenbergAbstractStochasticMutate() {
    }

    protected RechenbergAbstractStochasticMutate(final double chanceToMutate) {
    }
    ...
    public final void mutateSolution(final IVectorSolution<R> solution) {
        ...
        int mutatedBitsCount = (int)(Settings.getChanceToMutate() * size);
        final double chanceForExtraBit = Settings.getChanceToMutate() * size - mutatedBitsCount;
